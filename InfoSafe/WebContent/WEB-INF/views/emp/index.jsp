...
<body>
	...
	<center>
		...
		<c:if test="${sessionScope.totp==1 }">
			<a href="${pageContext.request.contextPath }/closeGoogle?id=${sessionScope.id }" >关闭谷歌验证</a><br>
		</c:if>
		<c:if test="${sessionScope.totp==0 }">
			<a href="${pageContext.request.contextPath }/openGoogle?id=${sessionScope.id }" >开启谷歌验证</a><br>
		</c:if>	
		<h4>欢迎来到员工管理系统</h4><br>
